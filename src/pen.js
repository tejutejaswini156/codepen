...
<body>
    ...
    else htmlEditor.session.setValue(localStorage.getItem("html"))
    ...
    else cssEditor.session.setValue(localStorage.getItem("css"))
    ...
    if (localStorage.getItem("js") == null)
        ...
        jsEditor.session.setValue(localStorage.getItem("js"))
